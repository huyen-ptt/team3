...
//@FXML
//    private ListView<RoomModel> listViewRooms;//id bảng
//
//    @FXML
//    private ListView<RoomModel, String> textRoomPrice;//id cột trong bảng 
//
//    public void initialize() {
//        textRoomPrice.setCellValueFactory(new PropertyValueFactory<>("Room price"));// tên cột trong db
//
//        ObservableList<RoomModel> ListView = FXCollections.observableArrayList(fetchDataFromDatabase());
//        listViewRooms.setItems(RoomModel);
//    }
//
//    private List<RoomModel> fetchDataFromDatabase() {
//        List<RoomModel> Categorys = new ArrayList<>();
//
...
//                int roomId = resultSet.getInt("categoryId");
//                String roomName = resultSet.getString("categoryName");
